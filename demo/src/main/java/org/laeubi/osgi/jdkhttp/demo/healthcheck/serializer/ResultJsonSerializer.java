 ...
 * {@code org.apache.felix.hc.core.impl.servlet.ResultJsonSerializer} - it
...
public class ResultJsonSerializer {
    ...
    private void writeResult(final HealthCheckExecutionResult healthCheckResult, boolean includeDebug, JSONWriter jsonWriter)
            throws IOException {
