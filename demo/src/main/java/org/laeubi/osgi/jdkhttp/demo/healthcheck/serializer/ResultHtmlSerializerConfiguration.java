 ...
 * {@code org.apache.felix.hc.core.impl.servlet.ResultHtmlSerializerConfiguration}.
 */
@ObjectClassDefinition(name = "Apache Felix Health Check Result HTML Serializer (JDK HttpServer demo)",
        description = "Serializer for health check results in HTML format")
public @interface ResultHtmlSerializerConfiguration {
