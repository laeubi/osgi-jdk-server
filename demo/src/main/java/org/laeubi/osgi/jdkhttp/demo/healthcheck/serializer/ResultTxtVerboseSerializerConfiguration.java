 ...
 * {@code org.apache.felix.hc.core.impl.servlet.ResultTxtVerboseSerializerConfiguration}.
 */
@ObjectClassDefinition(name = "Apache Felix Health Check Verbose Text Serializer (JDK HttpServer demo)",
        description = "Serializes health check results to a verbose text format")
public @interface ResultTxtVerboseSerializerConfiguration {
